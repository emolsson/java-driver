...
public class BoundStatement extends Statement implements SettableData<BoundStatement>, GettableData {
    ...
    public BoundStatement(PreparedStatement statement) {
        ...
        this.setCodecRegistry(statement.getCodecRegistry());
    }
     ...
     */
    @Override
    public <V> BoundStatement setObject(int i, V v, Class<V> targetClass) {
        return wrapper.setObject(i, v, targetClass);
    }
     ...
     */
    @Override
    public <V> BoundStatement setObject(String name, V v, Class<V> targetClass) {
        return wrapper.setObject(name, v, targetClass);
    }
     ...
     */
    @Override
    public <V> BoundStatement setObject(int i, V v, TypeToken<V> targetType) {
        return wrapper.setObject(i, v, targetType);
    }
     ...
     */
    @Override
    public <V> BoundStatement setObject(String name, V v, TypeToken<V> targetType) {
        return wrapper.setObject(name, v, targetType);
    }
    ...
    static class DataWrapper extends AbstractData<BoundStatement> {
        ...
        protected String getQualifiedName(int i) {
            ColumnDefinitions metadata = wrapped.statement.getVariables();
