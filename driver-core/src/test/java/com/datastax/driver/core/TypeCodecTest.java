...
public class TypeCodecTest {
    ...
    private CodecRegistry codecRegistry = new CodecRegistry()
        .register(CUSTOM_FOO_CODEC, true);
    ...
    public void test_cql_text_to_json() {
        ...
        org.assertj.core.api.Assertions.assertThat(codec.format(user)).isEqualTo(json);
        org.assertj.core.api.Assertions.assertThat(codec.parse(json)).isEqualToComparingFieldByField(user);
