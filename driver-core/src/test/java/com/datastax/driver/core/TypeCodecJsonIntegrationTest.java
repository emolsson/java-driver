...
public class TypeCodecJsonIntegrationTest {
    ...
    public void should_use_globally_registered_custom_codec_with_simple_statements() {
        cluster = Cluster.builder()
            ...
            .withCodecRegistry(
                new CodecRegistry()
                    .register(jsonCodec, true) // global User <-> varchar codec
            )
            .build();
        createSession();
    ...
    @Test(groups = "short")
    public void should_use_globally_registered_custom_codec_with_built_statements_1() {
        cluster = Cluster.builder()
            .addContactPoints(CCMBridge.ipOfNode(1))
            .withCodecRegistry(
                new CodecRegistry()
            ...
            .build();
        createSession();
        BuiltStatement insertStmt = insertInto("\"myTable\"")
            .value("c1", bindMarker())
            .value("c2", bindMarker())
            .value("c3", bindMarker());
    ...
    @Test(groups = "short")
    public void should_use_globally_registered_custom_codec_with_built_statements_2() {
        cluster = Cluster.builder()
            .addContactPoints(CCMBridge.ipOfNode(1))
            .withCodecRegistry(
                new CodecRegistry()
    ...
    public void should_use_overriding_codec() {
        cluster = Cluster.builder()
            ...
            .withCodecRegistry(
                new CodecRegistry()
                    .register(jsonCodec, "test.myTable.c2") // only test."myTable".c2 uses User <-> varchar codec
            )
            .build();
        createSession();
        try {
